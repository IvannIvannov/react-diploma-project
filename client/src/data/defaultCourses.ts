...
export const defaultCourses: Course[] = [
  {
    ...
    theory:
      "React е JavaScript библиотека за изграждане на потребителски интерфейси. Основната идея е приложението да бъде разделено на малки, самостоятелни и преизползваеми компоненти. Всеки компонент отговаря за конкретна част от интерфейса и може да съдържа собствена логика и визуална структура.",
